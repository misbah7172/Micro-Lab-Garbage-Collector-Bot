...
void rotateAndSearch() {
  int motorSpeed = 80; // Set speed to 50% (0-255 range)

  // Rotate left motor at 50% speed
  analogWrite(IN1, motorSpeed);  // Left motor forward at reduced speed
  digitalWrite(IN2, LOW);
  
  // Rotate right motor in reverse at 50% speed
  analogWrite(IN3, LOW);   // Right motor reverse at reduced speed
